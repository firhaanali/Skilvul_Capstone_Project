  ...
  <nav class="navbar navbar-expand-lg fixed-top";>
    ...
    <div class="btn-group">
        ...
        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-lg-start">
          <li><a class="dropdown-item" href="#"><i class="bi bi-person-circle"></i> &nbsp; </i>pengguna</a></li>
    ...
    <div>
      <div class="fs-2 fw-semibold" style="color: rgba(84, 91, 232, 1)">Jelajahi materi terbaik kami!</div>
            <div class="body-text mt-3" style="width: 80%">
                Temukan berbagai materi edukatif yang telah kami siapkan khusus untuk membantu Anda mengembangkan bisnis. Dari manajemen usaha hingga strategi pemasaran, semua ada di sini untuk mendukung perjalanan sukses Anda. Mari mulai belajar dan tingkatkan keterampilan Anda bersama Pandusaha!
            </div>
      </div>
  </div>
...
<div class="container mt-5">
    <div class="row">
        <!-- Card 1 -->
        <div class="col-md-4">
            <a href="/materi_manajemen" style="text-decoration: none; color: inherit;">
            ...
            <a href="index.html" style="text-decoration: none; color: inherit;">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Pelajari cara membangun identitas merek yang kuat dan unik untuk produk Anda.</p>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="index.html" style="text-decoration: none; color: inherit;">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Tingkatkan produktivitas bisnis dengan membangun tim yang solid dan berkolaborasi secara efektif.</p>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="index.html" style="text-decoration: none; color: inherit;">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Kuasai dasar-dasar pengelolaan keuangan untuk bisnis Anda. Dari pembukuan hingga analisis keuangan.</p>
                    </div>
                </div>
            </a>
        </div>
